...
void GimbalPostionTask(void const *argument)
{
	for (;;)
	{
		//sstarget_gimbal = (yaogan - 500) * 800;
...
void ShootTask(void const *argument)
{
	...
	for (;;)
	{
		...
		while(abs(motor_can2[4].total_angle-target_gimbal)>100)
		{
		osDelay(5);
		}
...
void left_qvmiao_Task(void const *argument)
{
	for (;;)
	{
		...
		else if (step_left_qvmiao == 1)
		{
			...
			left_qv_miao_2006[0] = 70000;
			left_qv_miao_2006[2] = 70000;
			osDelay(600);
			left_qv_miao = -340000;
		}
...
void right_qvmiao_Task(void const *argument)
{
	for (;;)
	{
		...
		else if (step_right_qvmiao == 1)
		{
			...
			right_qv_miao = 0;
			osDelay(600);
			right_qv_miao_2006[0] = 70000;
			right_qv_miao_2006[2] = 70000;
			osDelay(600);
			right_qv_miao = 340000;
		}
