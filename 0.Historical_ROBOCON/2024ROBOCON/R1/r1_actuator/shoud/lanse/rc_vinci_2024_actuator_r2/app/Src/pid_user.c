...
float motor_position_2006_pid_ARM[3] = {1, 0, 0.4};   // 机械抓后臄1�7
...
void PID_devices_Init(void)
{
	...
	PID_init(&pid_v_can2_2006[4], PID_POSITION, motor_speed_2006_pid, 8000, 1000);
	PID_init(&pid_p_can2_2006[4], PID_POSITION, motor_position_2006_pid_ARM, 8000, 500); // 云台
