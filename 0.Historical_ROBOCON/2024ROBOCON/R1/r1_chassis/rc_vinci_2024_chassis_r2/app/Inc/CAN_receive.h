...
void gm3508_cmd(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
void gm6020_cmd(int16_t motor5, int16_t motor6, int16_t motor7, int16_t motor8);
